...
/**
 * <b>功能名：TestPerson</b><br>
 * <b>说明：</b><br>
 * <b>著作权：</b> Copyright (C) 2021 HUIFANEDU  CORPORATION<br>
 * <b>修改履历：
 *
 * @author 2021-12-13 xuxiongzi
 */
...
public class TestPerson {
     ...
     * <b>方法名: </b> Test1 <br>
     * <b>说明: </b>  <br>
     * 筛选员工中工资高于 8000 的人，并形成新的集合。 形成新集合依赖collect（收集）
     *
     * @author 2021/12/13 xuxiongzi
     */
    @Test
    void test1() {
        ...
        System.out.println("工资高于8000的员工姓名" + fiterList);
    }
    ...
    void test3() {
        ...
        // 自定义排序2
        Optional<Integer> max3 = list.stream().max((o1, o2) -> o1.compareTo(o2));
    ...
    void test13() {
        ...
        personList.add(new Person("Alisa", 7900, 39, "female", "New York"));
        ...
        // 将员工先按性别分组，再按地区分组
        Map<String, Map<String, List<Person>>> group2 = personList.stream().collect(Collectors.groupingBy(Person::getSex,
                Collectors.groupingBy(Person::getArea)));

        System.out.println("员工按薪资是否大于8000分组情况：" + part);
        System.out.println("员工按性别分组情况：" + group);
        System.out.println("员工按按性别、地区：" + group2);
    }
    ...
    void test15() {
        ...
        System.out.println("员工扣薪资总和：" + sum);
